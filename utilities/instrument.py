...
from utilities.utils import datetimestamp, PROJECT_PATH
...
def generate_experiment(trainable_class, variant_spec, command_line_args):
    local_dir = os.path.join(variant_spec.get('log_dir'), variant_spec.get('task'))
    ...
    experiment_id = variant_spec.get('exp_name')
